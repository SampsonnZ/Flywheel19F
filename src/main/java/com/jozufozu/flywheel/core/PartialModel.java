 ...
 * PartialModels must be initialized during { net.minecraftforge.fml.event.lifecycle.FMLClientSetupEvent FMLClientSetupEvent}.
 * <br>
 * Once {ModelBakeEvent} finishes, all PartialModels (with valid modelLocations)
