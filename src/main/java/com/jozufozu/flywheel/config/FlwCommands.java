...
public class FlwCommands {
	...
	public static void booleanOptionCommand(LiteralArgumentBuilder<FabricClientCommandSource> builder, FlwConfig config,
											Option<Boolean> option, BiConsumer<FabricClientCommandSource, Boolean> displayAction,
											BiConsumer<FabricClientCommandSource, Boolean> setAction) {
		builder
				.executes(context -> {
	...
	public static <E extends Enum<E>> void enumOptionCommand(LiteralArgumentBuilder<FabricClientCommandSource> builder, FlwConfig config, com.jozufozu.flywheel.config.Option.EnumOption<E> option, Function<E, String> nameFunc, BiConsumer<FabricClientCommandSource, E> displayAction, BiConsumer<FabricClientCommandSource, E> setAction) {
